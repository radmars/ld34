	...
	this.addNode('engineering', {
		...
		left: function(state) {
			return {
				...
				pos: new me.Vector2d(0.5, 0.65)	 //pod status button
		...
		right: function(state) {
			return {
				...
				pos: new me.Vector2d(0.8, 0.65), //flush button
			};
		},
	}); //engineering
